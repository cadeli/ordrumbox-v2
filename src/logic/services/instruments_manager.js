...
const GM_DRUM_KEY_BY_NAME = Object.fromEntries(Object.entries(GM_DRUM_NAMES).map(([k, v]) => [v, Number(k)]))

/** Reverse map: melodic GM name → 0-indexed program number */
const GM_PROGRAM_NUM_BY_NAME = Object.fromEntries(Object.entries(GM_PROGRAM_NAMES).map(([k, v]) => [v, Number(k)]))
