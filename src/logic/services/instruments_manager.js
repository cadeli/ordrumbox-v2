...
export default class InstrumentsManager {
    static DATA = {
        "instruments": [
            ...
            { "subst": { "id1": "SNARE" }, "midi": [{ "ch": "10", "name": "High Floor Tom", "key": "43" }], "name": { "syn": [".*BEEP.*", ".*BIP.*", ".*ZAP.*", ".*POP.*", ".*SHOT.*",".*LASER.*",".*GUN.*"] }, "id": "HIT", "drum": true, "pan": "5" },
            ...
            { "subst": { "id1": "SNARE" }, "midi": [{ "ch": "10", "name": "High Timbale", "key": "65" }], "name": { "syn": [".*HTIMBAL.*", ".*HIGH.*TIMBAL.*"] }, "id": "HTIMBAL", "drum": true, "pan": "8" },
            { "subst": { "id1": "SNARE" }, "midi": [{ "ch": "10", "name": "Low Bongo", "key": "61" }], "name": { "syn": [".*LBONGO.*"] }, "id": "LBONGOS", "drum": true, "pan": "6" },
            { "subst": { "id1": "SNARE" }, "midi": [{ "ch": "10", "name": "Electric Snare", "key": "40" }], "name": { "syn": [".*LOOP.*"] }, "id": "LOOP", "drum": false, "pan": "0" },
            { "subst": { "id1": "SNARE" }, "midi": [{ "ch": "10", "name": "Low Timbale", "key": "66" }], "name": { "syn": [".*LTIMBAL.*", ".*LOW.*TIMBAL.*"] }, "id": "LTIMBAL", "drum": true, "pan": "0" },
            ...
            { "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HTOM" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*REED.*"] }, "id": "REED", "drum": false, "pan": "0" },
            { "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HTOM" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*CROMA.*", ".*CHROMATIC.*"] }, "id": "CROMAPERC", "drum": false, "pan": "0" },
            { "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HTOM" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*PIPE.*"] }, "id": "PIPE", "drum": false, "pan": "0" },
            { "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HTOM" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*ORGAN.*"] }, "id": "ORGAN", "drum": false, "pan": "0" },
            ...
            { "subst": { "id1": "SNARE", "id2": "HTOM", "id3": "CHH" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*TAMB.*"] }, "id": "TAMB", "drum": true, "pan": "0" },
            { "subst": { "id1": "HTOM", "id2": "MTOM", "id3": "CHH" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*TOM.*"] }, "id": "TOM", "drum": true, "pan": "2" },
            { "subst": { "id1": "HCONGAS" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*OHCONGA.*", ".*OPEN.*CONGA.*"] }, "id": "OHCONGAS", "drum": true, "pan": "0" },
            { "subst": { "id1": "BASS", "id2": "RIMSHOT", "id3": "HTOM" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*ETHN.*"] }, "id": "ETHNIC", "drum": false, "pan": "0" },
            { "subst": { "id1": "HIT", "id2": "CRASH", "id3": "RIMSHOT" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*VIBRA.*"] }, "id": "VIBRA", "drum": true, "pan": "0" },
            ...
            { "subst": { "id1": "HCONGAS", "id2": "CONGAS", "id3": "RIMSHOT" }, "midi": [{ "ch": "10", "name": "Hi Bongo", "key": "60" }], "name": { "syn": [".*HBONGO.*", ".*HIGH.*BONGO.*"], "adj_pitch": "HIGH" }, "id": "HBONGOS", "drum": true, "pan": "0" },
            { "subst": { "id1": "LTOM", "id2": "CRASH", "id3": "SNARE" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": ["TIMBALE"] }, "id": "TIMBAL", "drum": true, "pan": "0" },
            { "subst": { "id1": "HIT", "id2": "CRASH", "id3": "RIMSHOT" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*SYNTH.*PAD.*", ".*PAD.*"] }, "id": "SYNTHPAD", "drum": true, "pan": "0" },
            { "subst": { "id1": "HIT", "id2": "CRASH", "id3": "RIMSHOT" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*SYNTH.*EFFECT.*", ".*FX.*"] }, "id": "SYNTHEFFECT", "drum": true, "pan": "0" },
            { "subst": { "id1": "BRASS", "id2": "PIANO", "id3": "MELO" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*STRING.*"] }, "id": "STRINGS", "drum": false, "pan": "0" },
            { "subst": { "id1": "BRASS", "id2": "PIANO", "id3": "MELO" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*ENSEM.*"] }, "id": "ENSEMBLE", "drum": false, "pan": "0" },
            { "subst": { "id1": "HCONGAS", "id2": "HTOM", "id3": "RIMSHOT" }, "midi": [{ "ch": "4", "name": "Synth Voice", "programm": "5" }], "name": { "syn": [".*PERCUSS.*"] }, "id": "PERCUSSIVE", "drum": true, "pan": "0" },
