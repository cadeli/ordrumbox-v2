...
export default class InstrumentsManager {
    static DATA = {
        "instruments": [
            ...
            { "id": "BRASS", "midi": [{ "name": "Synth Brass 1", "key_based": false }], "subst": { "id1": "SYNTH", "id2": "MELO", "id2": "ORGAN" }, "name": { "syn": [".*BRASS.*"] }, "drum": false, "pan": "0" },
            ...
            { "id": "CLAP", "midi": [{ "name": "Hand Clap", "key_based": true }], "subst": { "id1": "SNARE" }, "name": { "syn": [".*CLAP.*", ".*CLP.*", "CP", ".*HAND.*"] }, "drum": true, "pan": "2" },
            ...
            { "id": "CRASH", "midi": [{ "name": "Crash Cymbal 1", "key_based": true }], "subst": { "id1": "CYM" }, "name": { "syn": [".*CYMBAL.*", ".*CYM.*", "CY", ".*CRASH.*", ".*PLASH.*"] }, "drum": true, "pan": "-8" },
            { "id": "CROMAPERC", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HI_TOM" }, "name": { "syn": [".*CROMA.*", ".*CHROMATIC.*"] }, "drum": false, "pan": "0" },
            { "id": "CYM", "drum": true, "pan": "0", "subst": { "id1": "CRASH" } },
            { "id": "ENSEMBLE", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "BRASS", "id2": "PIANO", "id3": "MELO" }, "name": { "syn": [".*ENSEM.*"] }, "drum": false, "pan": "0" },
            { "id": "ETHNIC", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "BASS", "id2": "RIMSHOT", "id3": "HI_TOM" }, "name": { "syn": [".*ETHN.*"] }, "drum": false, "pan": "0" },
            ...
            { "id": "MARACAS", "midi": [{ "name": "Maracas", "key_based": true }], "subst": { "id1": "CHH" }, "name": { "syn": ["MARA", "MA"] }, "drum": true, "pan": "8" },
            { "id": "MELO", "midi": [{ "name": "Percussive Organ", "key_based": false }], "subst": { "id1": "PIANO", "id2": "SYNTH", "id3": "TOM" }, "name": { "syn": [".*MELO.*"] }, "drum": false, "pan": "1" },
            ...
            { "id": "ORGAN", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HI_TOM" }, "name": { "syn": [".*ORGAN.*"] }, "drum": false, "pan": "0" },
            ...
            { "id": "PERCUSSIVE", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "HI_CONGAS", "id2": "HI_TOM", "id3": "RIMSHOT" }, "name": { "syn": [".*PERCUSS.*"] }, "drum": true, "pan": "0" },
            { "id": "PIANO", "midi": [{ "name": "Acoustic Grand Piano", "key_based": false }], "subst": { "id1": "MELO", "id2": "MTOM", "id3": "HI_TOM" }, "name": { "syn": ["RHODE"] }, "drum": false, "pan": "0" },
            { "id": "PIPE", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HI_TOM" }, "name": { "syn": [".*PIPE.*"] }, "drum": false, "pan": "0" },
            { "id": "RAZOR", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "HIT" }, "name": { "syn": ["RAZ", ".*RAZOR.*"] }, "drum": true, "pan": "5" },
            { "id": "REED", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HI_TOM" }, "name": { "syn": [".*REED.*", ".*OBOE.*"] }, "drum": false, "pan": "0" },
            ...
            { "id": "SOUNDEFFECT", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "CRASH", "id2": "HIT", "id3": "SCRATCH" }, "name": { "syn": [".*FX.*", ".*SOUND.*", ".*SND.*"] }, "drum": true, "pan": "0" },
            { "id": "STRINGS", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "BRASS", "id2": "PIANO", "id3": "MELO" }, "name": { "syn": [".*STRING.*"] }, "drum": false, "pan": "0" },
            ...
            { "id": "SYNTHLEAD", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "PIANO", "id2": "MELO", "id3": "HI_TOM" }, "name": { "syn": [".*SYNTH.*"] }, "drum": false, "pan": "0" },
            { "id": "SYNTHPAD", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "HIT", "id2": "CRASH", "id3": "RIMSHOT" }, "name": { "syn": [".*SYNTH.*PAD.*", ".*PAD.*"] }, "drum": true, "pan": "0" },
            ...
            { "id": "TIMBAL", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "LO_TOM", "id2": "CRASH", "id3": "SNARE" }, "name": { "syn": ["TIMBALE"] }, "drum": true, "pan": "0" },
            ...
            { "id": "WHISTLE", "midi": [{ "name": "Synth Voice", "key_based": false }], "subst": { "id1": "MARACAS", "id2": "RIMSHOT", "id3": "HIT" }, "name": { "syn": [".*WHISL.*"] }, "drum": true, "pan": "0" }
        ]
    };
