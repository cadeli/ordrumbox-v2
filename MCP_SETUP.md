...
- `addNotesToPattern({ patternName: "FourOnFloor", notes: [{ trackName: "CHH", step: 0, triggerFreq: 4 }] })`
- Or via `updateTrack({ patternName: "FourOnFloor", trackName: "CHH", updates: {}, noteUpdates: { triggerFreq: 4 } })`
...
| `setPatternNbBars` | Set number of bars |
...
- All step/bar indices are **0-indexed**
