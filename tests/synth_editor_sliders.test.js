...
describe('SynthEditor — OrSlider integration', () => {
    ...
    it('renders each numeric parameter as a range input inside an OrSlider row', () => {
    ...
    it('displays the initial value with the 2-decimal format', () => {
        trackEditor.synthEditor.openEditor()
        const panel = document.getElementById('soft-synth-panel')
    ...
    it('keeps select controls as native <select> (not sliders)', () => {
        trackEditor.synthEditor.openEditor()
        const panel = document.getElementById('soft-synth-panel')
    ...
    it('changing a slider updates the draft and calls updateGeneratedSounds', () => {
        trackEditor.synthEditor.openEditor()
        const panel = document.getElementById('soft-synth-panel')
    ...
    it('changing a deep path slider (filter.freq) updates the nested draft value', () => {
        trackEditor.synthEditor.openEditor()
        const panel = document.getElementById('soft-synth-panel')
        const freq = panel.querySelector('input[data-synth-path="filter.freq"]')
    ...
    it('re-opening the editor destroys old sliders and renders fresh ones', () => {
        trackEditor.synthEditor.openEditor()
        const panel = document.getElementById('soft-synth-panel')
