...
describe('computeLfoValue (single source of truth)', () => {
    ...
    describe('Frequency 1 (period = 16 beats = 128 ticks = 4 beats)', () => {
    ...
    describe('Frequency 2 (2 cycles in 128 ticks = 4 beats)', () => {
    ...
    describe('LFO sync contract: freq=1 = 4 beats (128 ticks) at 120 BPM', () => {
        const lfo = { freq: 1, phase: 0, min: 0, max: 1, waveform: 0 }
