...
describe('OrTab', () => {
  ...
  describe('renderBar', () => {
    ...
    it('includes escaped label text', () => {
      const tabs = [{ id: 'a', label: 'Hello' }, { id: 'b', label: 'World' }]
      const tab = new OrTab({ tabs })
      const html = tab.renderBar()
  ...
  describe('bindTo', () => {
    ...
    it('binds click handler to bar element found in root', () => {
      container.innerHTML = '<div class="ne-tab-bar"><button class="ne-tab-btn" data-ne-tab="drum">D</button><button class="ne-tab-btn" data-ne-tab="fx">F</button></div>'
      const tab = new OrTab({ tabs: defaultTabs, defaultTab: 'drum' })
    ...
    it('binds to root if root itself has the bar class', () => {
      ...
      container.innerHTML = '<button class="ne-tab-btn" data-ne-tab="drum">D</button><button class="ne-tab-btn" data-ne-tab="fx">F</button>'
      const tab = new OrTab({ tabs: defaultTabs, defaultTab: 'drum' })
      tab.bindTo(container)
      container.querySelector('[data-ne-tab="fx"]').click()
      expect(tab.active).toBe('fx')
    ...
    it('falls back to any descendant .ne-tab-bar if not direct child', () => {
      container.innerHTML = '<div><div class="ne-tab-bar"><button class="ne-tab-btn" data-ne-tab="drum">D</button><button class="ne-tab-btn" data-ne-tab="fx">F</button></div></div>'
      const tab = new OrTab({ tabs: defaultTabs, defaultTab: 'drum' })
      tab.bindTo(container)
      container.querySelector('[data-ne-tab="fx"]').click()
      expect(tab.active).toBe('fx')
