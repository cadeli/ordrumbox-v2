...
describe('Profile heavy song (64 beats, 8 tracks, synths, LFOs, automation)', () => {
    let pattern
    let flatNotes
    ...
    it('measures load, memory, FPS, GC, and CPU proxy', async () => {
        ...
        console.log('\n========== PROFILE REPORT ==========')
        console.log(`Pattern       : ${NB_BEATS} beats × ${NB_TRACKS} tracks × ${STEPS_PER_BEAT} steps (${noteCount} notes, ${pattern.bpm} BPM)`)
